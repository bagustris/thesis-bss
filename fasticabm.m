% Fastica with Binary Mask
% Adopted from M.S. Pedersen et. al, "Two-Micrphone Separation..."
clear all; close all;
...
for n=1:sx
    ...
    [y{n},Aest,Wf]=fastica(x{n},'approach','symm', 'finetune', 'tanh'); 
    %[y{n},Aest] = icaML(x{n});
